...
//The main objective of the C++ project is to manage the detail of products,
//payment, purchasing. it manages all the information about product,
//customer, sales. This project is totally at the administrative end and thus
//only the administrator is guaranteed to access.
